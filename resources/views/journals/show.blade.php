        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <h2 class="font-semibold text-3xl text-gray-800 dark:text-gray-100 leading-tight tracking-tight">
                    {{ $journal->title ?: 'Jurnal Tanpa Judul' }}
                </h2>
            </div>
            <div class="flex items-center space-x-3">
                ...
                <form action="{{ route('journals.destroy', $journal) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus jurnal ini secara permanen?');" class="inline">
                    @csrf
                    @method('DELETE')
                ...
                <div class="p-8 sm:p-12">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 pb-8 border-b border-gray-100 dark:border-gray-800">
                        <div class="flex items-center mb-4 sm:mb-0">
                            ...
                            <div class="ml-5">
                                <p class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Skor Mood</p>
                                <p class="text-lg font-bold text-emerald-600 dark:text-emerald-400">{{ $journal->mood_score }} / 5</p>
                            </div>
                        </div>
                        <div class="text-left sm:text-right">
                            <p class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Ditulis Pada</p>
