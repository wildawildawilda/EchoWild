                ...
                <div class="p-8 sm:p-12" x-data="journalForm()">
                    <form action="{{ route('journals.update', $journal) }}" method="POST">
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <a href="{{ route('journals.show', $journal) }}" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 font-medium text-sm transition-colors">
                                Batal
                            </a>
