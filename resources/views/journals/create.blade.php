                ...
                <div class="p-8">
                    <form action="{{ route('journals.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" id="title" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" placeholder="Apa yang Anda pikirkan?" value="{{ old('title') }}">
                            @error('title')
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="content" id="content" rows="10" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm" placeholder="Tulis keseharian atau refleksi Anda di sini..." required>{{ old('content') }}</textarea>
                            @error('content')
                                <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex items-center space-x-4" x-data="{ mood: {{ old('mood_score', 3) }} }">
